...
namespace Northwind.Entity.Mapper
{
    public class MappingProfile:Profile
    {
        ...
        {
            CreateMap<Customer, DtoCustomer>().ReverseMap();//yerleri değişebilir iki işlemi de yapar.
            CreateMap<AlphabeticalListOfProduct, DtoAlphabeticalListProduct>().ReverseMap();
